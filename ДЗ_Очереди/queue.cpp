...
void enqueue(queue& q, const char* lastname, const char* sex, int age, const char* job, int payment, const char* goal)
{
	man* new_man = new man;
	new_man->age = age;
	new_man->payment = income;
	strcpy_s(new_man->lastname, name);
...
/**
 * ѕолучение информации о длине сообщени€ от пользовател€, переданного
 * методом POST
 */
...
/**
 * ѕолучение данных из формы в необработанном виде
 */
...
/**
 * ѕолучение значени€ конкретного параметра, полученного от пользовател€
 */
...
/**
 * –аскодирование переданных данных
 */
